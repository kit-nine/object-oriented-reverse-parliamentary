...
print("Bills passed this run:", results.count(True))
print("Bills killed this run:", results.count(False))
print("Total bills gone through senate this run:", len(results))